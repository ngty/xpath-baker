module XPathBaker
  ...
  #
  #   xpath-baker.tr({:cells => %w{cell1 cell2 cell3}, :match_ordering => true)
  #
  ...
  #
  #   xpath-baker.tr({:cells => %w{cell1 cell2 cell3}, :match_ordering => false)
  #
  ...
  class Configuration
    ...
    # %w{g c o n i 1~7$ descendant-or-self::a //body/watever XPathBaker::Matchers::Attribute XPathBaker::Matchers::Text}
    DEFAULT_SETTINGS = {
      :greedy             => true,       # g, !g
